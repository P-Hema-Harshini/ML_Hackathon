...
headers = {
        "X-RapidAPI-Key": "d993f46af2msh15c78f5927a6e26p148ce7jsnca7f393bcd54",  # Replace with your API key
...
def load_user_data(profile_url):
    ...
    st.write(skills)
    st.warning('if there is an error saying invalid key "data" it means that the apikey is expired . use a valid key to get data')
    df=pd.DataFrame()
